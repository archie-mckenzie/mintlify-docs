...
<ParamField body="query, path, body, or header" type="string">
  Gibt an, ob es sich um einen Query-, Path-, Body- oder Header-Parameter handelt, gefolgt vom
  Parameternamen.
</ParamField>
...
<ParamField body="placeholder" type="string">
  Platzhaltertext für die Eingabe in der Spielwiese.
</ParamField>
...
<ResponseField name="type" type="string" required>
  Erwarteter Typ des Rückgabewerts. Dies kann eine beliebige Zeichenfolge sein.
</ResponseField>
...
<ResponseField name="required" type="boolean">
  Gibt an, ob der Rückgabewert erforderlich ist.
</ResponseField>
