...
Verwenden Sie CSS, um HTML-Elemente zu gestalten, oder fügen Sie eigenes CSS und JavaScript hinzu, um Erscheinungsbild und Verhalten Ihrer Dokumentation vollständig anzupassen.
...
Sie können beispielsweise die folgende Datei `style.css` hinzufügen, um die Navigation (Navbar) und den Footer zu gestalten.
...
Mintlify stellt eine Reihe gängiger Identifikatoren und Selektoren bereit, mit denen Sie wichtige UI-Elemente markieren können.

<Tip>
  Verwenden Sie „Element untersuchen“, um Referenzen auf Elemente zu finden, die Sie anpassen möchten.
</Tip>
...
<Warning>
  Referenzen und das Styling häufig verwendeter Elemente können sich ändern, während sich die Plattform weiterentwickelt. Bitte verwenden Sie benutzerdefiniertes Styling mit Vorsicht.
</Warning>
...
Benutzerdefiniertes JS ermöglicht es Ihnen, global eigenen ausführbaren Code hinzuzufügen. Das entspricht dem Einfügen eines `<script>`-Tags mit JS-Code auf jeder Seite.

<div id="adding-custom-javascript">
  ### Benutzerdefiniertes JavaScript hinzufügen
</div>

Alle `.js`-Dateien im Content-Verzeichnis Ihrer Dokumentation werden auf jeder Dokumentationsseite eingebunden. Sie können beispielsweise die folgende Datei `ga.js` hinzufügen, um [Google Analytics](https://marketingplatform.google.com/about/analytics) in der gesamten Dokumentation zu aktivieren.
...
<Warning>
  Bitte verwenden Sie dies mit Vorsicht, um keine Sicherheitslücken zu verursachen.
</Warning>
