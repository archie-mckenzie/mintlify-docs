---
title: "Einführung"
description: "Lernen Sie die nächste Generation der Dokumentation kennen: KI-nativ, sofort einsatzbereit und für Entwickler entwickelt."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="cli" title="CLI-Installation" description="Installieren Sie die CLI, um Ihre Docs lokal zu entwickeln und in der Vorschau anzuzeigen" href="/de/installation" />
