---
title: "Einführung"
description: "Lernen Sie die nächste Generation der Dokumentation kennen: KI-native, sofort einsatzbereit schön und für Entwickler gebaut."
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    <h1 className="block text-4xl font-medium text-center text-gray-900 dark:text-zinc-50 tracking-tight">
      Dokumentation, jetzt mehrsprachig!
    </h1>

    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      Lernen Sie die nächste Generation der Dokumentation kennen: KI-native, sofort einsatzbereit schön und für Entwickler gebaut.
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Schnellstart" description="Setzen Sie Ihre erste Doku-Website in wenigen Minuten mit unserer Schritt-für-Schritt-Anleitung auf" href="/de/quickstart" />
      ...
      <HeroCard filename="editor" title="Web-Editor" description="Nehmen Sie schnelle Updates vor und verwalten Sie Inhalte mit unserem browserbasierten Editor" href="/de/editor" />

      <HeroCard filename="components" title="Komponenten" description="Erstellen Sie umfangreiche, interaktive Dokumentation mit unseren sofort einsatzbereiten Komponenten" href="/de/text" />
    </div>
  </div>
</div>
