---
title: "はじめに"
description: "次世代のドキュメンテーション。AIネイティブ、美しいデフォルト、開発者のために構築。"
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      次世代のドキュメントを体験しましょう。AIネイティブ、デフォルトで美しく、開発者向けに設計されています。
    </div>

    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="クイックスタート" description="ステップバイステップガイドで数分で最初のドキュメントサイトをデプロイ" href="/ja/quickstart" />

      <HeroCard filename="cli" title="CLIのインストール" description="CLIをインストールしてローカルでドキュメントをプレビュー・開発" href="/ja/installation" />

      <HeroCard filename="editor" title="ウェブエディター" description="ブラウザベースのエディターで素早く更新し、コンテンツを管理" href="/ja/editor" />

      <HeroCard filename="components" title="コンポーネント" description="すぐに使えるコンポーネントでリッチでインタラクティブなドキュメントを構築" href="/ja/text" />
    </div>
  </div>
</div>
