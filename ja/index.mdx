---
title: "概要"
description: "次世代のドキュメントに出会おう。AIネイティブ、箱から出してすぐに美しく、開発者のために設計されています。"
icon: "book-open"
mode: "custom"
---
...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="max-w-xl mx-auto px-4 mt-4 text-lg text-center text-gray-500 dark:text-zinc-500">
      次世代のドキュメント。AIネイティブ、標準で美しく、開発者のために設計されています。
    </div>
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      ...
      <HeroCard filename="cli" title="CLIのインストール" description="ローカルでドキュメントをプレビュー・開発するためにCLIをインストール" href="/ja/installation" />

      <HeroCard filename="editor" title="Webエディター" description="ブラウザベースのエディターで素早く更新し、コンテンツを管理" href="/ja/editor" />

      <HeroCard filename="components" title="コンポーネント" description="すぐ使えるコンポーネントで、リッチでインタラクティブなドキュメントを構築" href="/ja/text" />
    </div>
  </div>
</div>
